    ...
    <div name="contact" className='w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/c503797a-13a3-4c7c-8497-545880cf5f37" method='POST' className='flex flex-col w-full md:w-1/2'>
                    ...
                    <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-5 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300 '>Let&apos;s talk</button>
                </form>
            </div>
        </div>
    </div>
